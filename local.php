...
<div class="container-fluid">
  <div class="container">
    ...
    <div class="container" >
      <h3>Caravanas</h3>
        <p>Está aberto o programa Caravanas da ERRC \o/ </p>
          

        <h4>O que é considerado uma caravana?</h4>
        
        <p>Um grupo com pelo menos 8 integrantes que chegue ao evento através de um mesmo meio de transporte (kombi, van, micro-ônibus, ônibus, etc.).
        </p>
        ...
        <h4>Cronograma</h4>
        <ul>
        <li>Envio da relação dos integrantes e agendamento de horários de chegada e partida dos grupos: 09/08/2019</li>
        <li>Recepção das caravanas: 16/09/2019</li>
        </ul>
        
        <h3><a href="inscricoes.php?#caravanas">Inscreva já sua caravana aqui!</a></h3>
