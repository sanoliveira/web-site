<h4>ERRC 2019: Lista Provisória de Papers Aceitos</h4>
<p>
...
<br>
<b>Fog Computing: análise de desempenho computacional</b>
...
<br>
<b>Proposta de Monitoramento e Gerenciamento Inteligente de Temperatura em Datacenters</b>
<i>Djalma Teixeira (Sociedade Educacional Três de Maio - SETREM), Adriano Vogel (PUCRS), Dalvan Griebler (PUCRS/SETREM)</i>
<br>
...
<i>Daniel Stasiak, Walter Priesnitz Filho (Universidade Federal de Santa Maria - UFSM)</i>
<br>
<b>Projeto redes: implementação de uma MANET para a conexão de dispositivos IoT utilizando protocolo OLSR</b>
<i>Joao Mário Brezolin, Cristiano Nunes (Instituto Federal Sul-Rio-Grandense - IFSul)</i>
<br>
<b>LAZE - Um poderoso analisador de logs do Squid</b>
<i>Natália Knob (IFRS), Luis Knob (Pontifícia Universidade Católica do Rio Grande do Sul - PUCRS), Eduardo Germano da Silva (Universidade Federal do Rio Grande do Sul - UFRGS), Cristian Cleder Machado (Universidade Regional Integrada (URI) - Câmpus de Frederico Westphalen), Diego Lusa(IFRS - Campus Sertão)</i>
<br>
<b>Uma Comparação dos Dados da Ferramenta Zabbix com a Percepção dos Usuários da Rede no Instituto Federal Catarinense ? Campus Avançado Sombrio</b>
<i>Liliana Colares, Matheus Braga, Victor Martins de Sousa, Diuliana da Rosa (Instituto Federal Catarinense - Campus Sombrio - IFC Sombrio)</i>
<br>
...
<br>
<b>Firewalls em Redes Definidas por Software: Estado da Arte</b>
<i>Maurício Fiorenza, Diego Kreutz (Universidade Federal do Pampa - UNIPAMPA)</i>
<br>
<b>Análise de segurança no uso de contêineres Docker em máquinas virtuais</b>
<i>Kerolayne Oliveira, Charles Miers (Universidade do Estado de Santa Catarina - UDESC)</i>
<br>
<b>Um Algoritmo de Balanceamento de Carga para a Computação em Névoa</b>
<i>Eder Pereira, Moisés Oliveira, Ivania Fischer (UFSM), Edson Luiz Padoin (UNIJUI/UFRGS), Roseclea Medina (Universidade Federal de Santa Maria - UFSM)</i>
<br>
<b>O Impacto Sustentável das Redes Móveis Densas Heterogêneas no Futuro 5G - Levantamento Bibliográfico</b>
<i>Luis Eduardo Simioni Centeleghe, Luis Felipe dos Santos Vasconcelos (Instituto Federal de Educação, Ciência e Tecnologia do Rio Grande do Sul - Campus Canoas)</i>
<br>
...
<h4>ERRC 2019: Lista Provisória de Resumos Estendidos Aceitos</h4>
<p>
