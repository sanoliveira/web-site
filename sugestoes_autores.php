...
<ul class="lista">
   ...
   ''</a>, escrito por S. Keshav.
      ...
      <li>Para planejar aspectos mais específicos do artigo a ser submetido para a ERRC, pode ser útil analisar o formulário que será empregado pelos revisores.
      Use o formulário como guia para auto-avaliar o seu artigo. Verifique, por exemplo, no quesito originalidade, se o seu
      ...
      <li>
      Na prepara&ccedil;&atilde;o do seu artigo, use o formato exigido. O ERRC/WRSeg 2019 exige o <a href="http://www.sbc.org.br/documentos-da-sbc/category/169-templates-para-artigos-e-capitulos-de-livros">
      modelo da SBC</a>. Atente para o espaço disponível.
      </li>   
   </ul> 
   </li>
   ...
   <ul class="lista">
      ...
      <li>
      Outro bom material em português é o <a href="http://1.49.d5.sl.pt/">"Como escrever um Artigo Cient&iacute;fico ou T&eacute;cnico: Alguns Aspectos"</a>.
      </li>
      
      <li>
      &Eacute; importante tamb&eacute;m entender os principais aspectos elencados em <a href="https://www.scribd.com/document/11655966/Como-Nao-Escrever-um-Artigo-Cientifico">"Como (n&atilde;o) Escrever um Artigo T&eacute;cnico-Cient&iacute;fico"</a>.
      </li>

      <li>
      <a href="http://www.ic.unicamp.br/~rodolfo/dicas/escrita.html">"Dicas sobre escrita"</a> e <a href="http://www.ic.unicamp.br/~rodolfo/dicas/apresentacoes.html">"Dicas sobre apresenta&ccedil;&otilde;es"</a>, elaboras por Rodolfo de Azevedo, cont&eacute;m  dicas importantes e &uacute;teis para escrita e apresentação de artigos.
      </li>
      ...
      <li>
      <a href="https://www.bartleby.com/141/index.html">"The Elements of Style"</a> &eacute; uma refer&ecirc;ncia interessante para compreender e aplicar elementos de estilo na escrita.
      </li> 

      <li>
      A Introdu&ccedil;&atilde;o (<a href="http://www.cs.columbia.edu/~hgs/etc/intro-style.html">"Writing a good introduction"</a>) é fundamental para ``converter'' um potencial leitor, que se interessou pela introdução, em um leitor do trabalho completo.
      </li>
      ...
      <li>
      "On Writing Well", escrito por William Zinsser, &eacute; um dos melhores e mais sucintos livros sobre como escrever bem.  Apesar de ser um livro voltado para escrita em ingl&ecirc;s, boa parte de suas dicas podem ser aplicadas em outras l&iacute;nguas, como portugu&ecirc;s. Uma  dica apresentada é dar preferência para palavras simples, frases curtas e objetivas.
      </li>
   ...
   <ul class="lista">
      ...
      <li>Trocar a cor da fonte ou o meio (eletrônico/impresso) pode ajudar recobrar a concentração em trechos que já tenham sido revisados múltiplas vezes anteriormente.
      </li>
      ...
      <li>
      Por fim, imprima o artigo, idealmente em uma via colorida e outra preto e branco, e procure detectar possíveis problemas de impressão.
      </li>
   </ul>
   </li>
   </ul>
